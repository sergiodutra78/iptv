        ...
        if (storedConfig) {
            try {
                ...
                if (parsed.xtreamCodes) {
                    setBaseUrl(parsed.xtreamCodes.baseUrl || IPTV_CONFIG.xtreamCodes.baseUrl);
                    setUsername(parsed.xtreamCodes.username || IPTV_CONFIG.xtreamCodes.username);
                    setPassword(parsed.xtreamCodes.password || IPTV_CONFIG.xtreamCodes.password);
                }
